...
| M6C - One-page deterministic normalization | review fixes implemented; focused re-review and local artifact acceptance pending | Clean stack over `97a6747`; round-1 P1/P2 fixes pass 101 focused and 906 broad offline tests | Retains contract-mandated placeholder identities and multiline macro/code content; not yet approved. |
