...
| M7 - Crawl reliability and scale | B1 complete and independently approved; B2 planning next | M7-A contracts approved; structured HTTP outcome boundary implemented and verified | Plan the pure bounded retry-policy evaluator; B3 remains blocked. |
...
are implemented and independently approved with existing M5B/M6B behavior
preserved. M7-B2 pure bounded retry-policy planning is next; M7-B3 remains
blocked.
...
- M7-B2: pure bounded retry-policy evaluator. Planning next; no I/O or sleep.
- M7-B3: rate-limited retry executor. Blocked by B2 review and approval.
