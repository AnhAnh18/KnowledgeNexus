...
from knowledgenexus.foundation.ports.confluence_checkpoint_state_port import (
    ...
    ConfluenceRawPageReplayFailureCategory,
    ConfluenceRawPageReplayResult,
    ...
    ConfluenceRawRestrictionReplayCommand,
    ConfluenceRawRestrictionReplayDecision,
    ConfluenceRawRestrictionReplayFailure,
    ConfluenceRawRestrictionReplayFailureCategory,
    ConfluenceRawRestrictionReplayResult,
)
