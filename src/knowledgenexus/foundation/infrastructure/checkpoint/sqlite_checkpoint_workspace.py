...
_OBJECTS = {"checkpoint_metadata", "crawl_runs", "crawl_sessions", "include_roots", "root_occurrences", "root_progress", "inventory_windows", "inventory_occurrences", "raw_page_progress", "checkpoint_transitions", "request_budget_reservations", "idx_crawl_sessions_run_started", "idx_crawl_sessions_one_active", "idx_inventory_occurrences_run_page", "idx_inventory_windows_run_root", "idx_root_progress_incomplete"}
